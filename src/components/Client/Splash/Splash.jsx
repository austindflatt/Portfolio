      ...
      <div className="splash-inner">
        ...
        <div className="splash-media">
          <div className="splash-media-container">
            {isFetching ? 
            <Skeleton><img width='330px' height='410px' alt='' /></Skeleton> : <img src="https://austinflatt-public-assets.s3.us-east-2.amazonaws.com/public/me.png" loading="lazy" alt="Headshot" />
            }
          </div>
        </div>
      </div>
