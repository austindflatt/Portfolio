...
import { HeaderNav, Main, Login, Register, AboutData, Contact, AboutPage, ProjectsCollection, PageNotFound, Footer, GlobalStyle } from './components';
    ...
    <div>
      <BrowserRouter>
        ...
        <Switch>
          ...
          <Route exact path='/update-details' component={AboutData} />
