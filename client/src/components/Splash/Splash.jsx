                ...
                <Container>
                    <div className="splash-inner">
                        <div className="splash-copy">
                            ...
                            <SocialLink href={social.twitch} rel="noreferrer" target="_blank">
                            ...
                            <div className="splash-cta">
                                <Button href={data.resume} rel="noreferrer" target="_blank">
                                    Resume
                                </Button>
                            </div>
                            ...
                            <div className="splash-media-container">
                                <img src={data.headshot} loading="lazy" alt="Headshot" />
                            </div>
                        </div>
                    </div>
                </Container>
